...
التطبيق لا يقدّم قائمة نماذج ثابتة بوصفها حقيقة دائمة. عند تشغيل الخادم أو تحديث قائمة النماذج، يقرأ الخادم المفاتيح المهيأة، يطلب `/v1/models` من كل مزود، يطبع النماذج القابلة للاكتشاف، ثم يعرضها في الواجهة مع حالة المزود وعدد النماذج. إذا تعذر الوصول إلى مزود، تظهر حالة واضحة بدلاً من إخفاء الخطأ أو الادعاء بأن النموذج متاح. وقد بيّن [تقرير التحقق الشامل](docs/model-verification-2026-09-01.md) أن كتالوج المزود قد يتضمن معرفات غير محادثية أو مقيدة بسياسات ورصيد ونقاط نهاية مختلفة؛ لذلك لا يُعد ظهور النموذج في القائمة ضماناً لنجاح كل طلب محادثة.
...
| `docs/model-verification-2026-09-01.md` | تقرير اختبار 689 نموذجاً عبر OpenAI وOpenRouter وHugging Face. |
